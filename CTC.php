  ...
  <div class="row content">
    ...
    <div id="container" class="col-sm-8 text-left">
      <div class="text-center">
        <h1 id='title'>Cross-Train Challenge</h1>
      ...
      <div class="row content">
        <div class="col-sm-5 text-center" id="subIcons">
          <h3>Course Outline</h3>
            <p>
                CTC is a gritty, sweaty, full-body workout that will take your fitness to the next level. Strength, endurance, resistance, and functionality are all addressed.
            </p>
        </div>
      ...
      <div class="row content">
        ...
        <div class="col-sm-6 text-center">
            ...
            <button onClick='addCTC()'>Join</button>
            <button>Leave</button>
        </div>
      </div>
