  ...
  <div class="row content">
    ...
    <div id="container" class="col-sm-8 text-left">
      <div class="text-center">
        <h1 id='title'>Ladies Who Lift</h1>
      ...
      <div class="row content">
        <div class="col-sm-5 text-center" id="subIcons">
          <h3>Course Outline</h3>
            <p>
                This Women's only small Personal Training Session is for any and all women who are new to weight training or want to advance their current program and get results. If you want to gain the confidence and execute perfect lifting techniques specific for women, this is the program for you.
            </p>
        </div>
      ...
      <div class="row content">
        ...
        <div class="col-sm-6 text-center">
            ...
            <button onClick='addLadiesWhoLift()'>Join</button>
            <button>Leave</button>
        </div>
      </div>
