  ...
  <div class="row content">
    ...
    <div id="container" class="col-sm-8 text-left">
      <div class="text-center">
        <h1 id='title'>Weekend Recovery</h1>
      ...
      <div class="row content">
        <div class="col-sm-5 text-center" id="subIcons">
          <h3>Course Outline</h3>
            <p>
                This early morning Yoga Flow recovery class will help you detoxify the liver, re-oxygenate the body and help you tackle the week ahead with a clear and focused mind. Great for students and staff alike.
            </p>
        </div>
      ...
      <div class="row content">
        ...
        <div class="col-sm-6 text-center">
            ...
            <button onClick='addWeekendRecovery()'>Join</button>
            <button>Leave</button>
        </div>
      </div>
