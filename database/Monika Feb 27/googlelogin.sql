...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 28, 2018 at 06:58 AM
...
(4, 'CrossTrainChallenge', '3700 Willingdon Ave, Burnaby, BC V5G 3H2', 'CTC is a gritty, sweaty, full-body workout that will take your fitness to the next level. Strength, endurance, resistance, and functionality are all addressed.', '2018-03-01T14:00:00-08:00', '2018-03-01T15:00:00-08:00'),
...
--
ALTER TABLE `user_recreation`
  MODIFY `user_rec_id` int(11) NOT NULL AUTO_INCREMENT;
--
